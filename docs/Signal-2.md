...
### 2. Basic Materials Concentration Alert
...
- **Action:** Show yellow alert flagging concentration risk. No signal override — user decides.

| Condition | Alert | Color |
|-----------|-------|-------|
| 3+ stocks in Basic Materials / Mining with buy signals | Concentration Alert (Basic Materials) | t-yellow |
...
Confirmed 80+ crossings achieve 70–78% win rates vs 66% for instant entry.
...
| Buy | SA crosses above 75, holds 3 days | MC 30+ | t-green |
...
Gradual declines landing above 75 produce 62–70% win rates — stronger than fresh entries.
...
| 75 | Secondary entry | Entry in MC 30+ only |
| 70 | Danger zone | Monitor closely |
| 65 | Weak zone | Do not buy |
